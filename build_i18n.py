...
translations = {
    ...
    "Инспектор 3D моделей для Three.js и WebGL Playables. Подсчет полигонов, проверка анимаций и генерация Base64 кода.": "3D model inspector for Three.js and WebGL Playables. Polycount inspection, animation checks, and Base64 generator.",
