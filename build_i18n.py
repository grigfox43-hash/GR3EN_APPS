...
translations = {
    ...
    "3D MODEL VIEWER & OPTIMIZER": "3D MODEL VIEWER & OPTIMIZER",
    "Инспектор 3D моделей всех популярных форматов (GLB, GLTF, OBJ, FBX, STL, PLY, DAE) для Three.js и WebGL Playables. Подсчет полигонов, проверка анимаций, материалов и генерация кода вставки.": "Inspector for 3D models across all popular formats (GLB, GLTF, OBJ, FBX, STL, PLY, DAE) for Three.js and WebGL Playables. Polycount inspection, animation checks, materials, and embed generator.",
    "3D МОДЕЛЬ": "3D MODEL",
    "Перетащите 3D файл сюда": "Drop 3D file here",
    "Перетащите 3D файл сюда<br><span style=\"font-size: 0.75rem; color: var(--color-text-muted);\">(GLB, GLTF, OBJ, FBX, STL, PLY, DAE)</span>": "Drop 3D file here<br><span style=\"font-size: 0.75rem; color: var(--color-text-muted);\">(GLB, GLTF, OBJ, FBX, STL, PLY, DAE)</span>",
    "Формат:": "Format:",
    "🪙 3D Монета": "🪙 3D Coin",
    "📦 3D Сундук": "📦 3D Chest",
    ...
    "Скопировать Base64 Data URI": "Copy Base64 Data URI",
    "Скопировать Base64 GLB": "Copy Base64 Data URI",
    ...
    "3D Model Viewer (GLB, OBJ, FBX)": "3D Model Viewer (GLB, OBJ, FBX)",
    "Инспектор 3D моделей всех форматов (GLB, GLTF, OBJ, FBX, STL, PLY, DAE) для Three.js. Подсчет полигонов, проверка анимаций и Base64 код.": "Inspector for 3D models across all formats (GLB, GLTF, OBJ, FBX, STL, PLY, DAE) for Three.js. Polycount inspection, animation checks, and Base64 code.",
    ...
    "🩺 PLAYABLE SIZE DOCTOR & BUNDLE TREEMAP": "🩺 PLAYABLE SIZE DOCTOR & BUNDLE TREEMAP",
    "Глубокий анализ веса бандла, обнаружение тяжелых Base64 ресурсов, дубликатов и интерактивная карта размера.": "Deep bundle weight analysis, detection of heavy Base64 assets, duplicates, and interactive size treemap.",
    "🧹 Скачать очищенный HTML": "🧹 Download Cleaned HTML",
    "Вес файла / Лимит:": "File Size / Limit:",
    "🖼️ Картинки (Base64):": "🖼️ Images (Base64):",
    "🔊 Звуки (Audio):": "🔊 Audio (Sounds):",
    "📜 JavaScript / Движки:": "📜 JavaScript / Engines:",
    "🎨 CSS + 📄 HTML:": "🎨 CSS + 📄 HTML:",
    "Чистый код": "Clean code",
    "Шрифты и разметка": "Fonts and markup",
    "🗺️ ИНТЕРАКТИВНАЯ КАРТА РАСПРЕДЕЛЕНИЯ ВЕСА (TREEMAP):": "🗺️ INTERACTIVE BUNDLE WEIGHT TREEMAP:",
    "Картинки": "Images",
    "Аудио": "Audio",
    "Скрипты (JS)": "Scripts (JS)",
    "Стили (CSS)": "Styles (CSS)",
    "Шрифты": "Fonts",
    "HTML": "HTML",
    "💡 ДИАГНОСТИКА И РЕКОМЕНДАЦИИ ДОКТОРА РАЗМЕРА:": "💡 SIZE DOCTOR DIAGNOSTICS & RECOMMENDATIONS:",
    "📋 ТОП ВНЕДРЕННЫХ BASE64 РЕСУРСОВ ПО ВЕСУ:": "📋 TOP EMBEDDED BASE64 ASSETS BY SIZE:",
    "0 ресурсов": "0 assets",
    "MIME / Превью": "MIME / Preview",
    "Размер": "Size",
    "% от бандла": "% of bundle",
    "Действие": "Action",
    "ДУБЛИКАТ": "DUPLICATE",
    "Копировать": "Copy",
    "Внедренных Data URI ресурсов не обнаружено": "No embedded Data URI assets found",
